# Tasks
Important: Update the tasks progress while progressing. When starting a new task, start from a new, clean branch (unless otherwise specified). Commit after a task is successfully completed. One task per commit.
